...
void rayRenderLoop(WindowedDrawing& rawCanvas, const bool& exit_requested,
	...
	const static Scene scene{
	        {
             Sphere(dvec3{0.0, -1.0, 3.0}, 1.0,
             Color{Category{true, 9}, RGBA{255, 0, 0, 255}}, 500, 0.2),
             Sphere(dvec3{2.0, 0.0, 4.0}, 1.0,
             Color{Category{true, 10}, RGBA{0, 0, 255, 255}}, 500, 0.3),
             Sphere(dvec3{-2.0, 0.0, 4.0}, 1.0,
             Color{Category{true, 11}, RGBA{0, 255, 0, 255}}, 10, 0.4),
